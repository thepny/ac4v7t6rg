...
mp.events.add("orangeOpenMenu", (json) => {
	...
	global.menuOpen();
	global.menuOrange = mp.browsers.new('http://package/browser/modules/Jobs/Orange/index.html');
...
mp.events.add("OpenWorkMenuOrange", (lvl, pay1, pay2, workid, work1, work2) => {
	...
	global.menuWorkOrange = mp.browsers.new('http://package/browser/modules/Jobs/Orange/jobsmenu/index.html');
