...
var editing_types = ["Позиция по X", "Позиция по Y", "Поворот"];
var editing_type_idx = 0;

global.editing = false;
var object = null;

mp.events.add('startEditingE', function (model) {
    object = mp.objects.new(mp.game.joaat(model), new mp.Vector3(global.localplayer.position.x+1, global.localplayer.position.y+1, global.localplayer.position.z-1.12), //global.localplayer.getCoords(true),
        {
...
mp.events.add('endEditingE', function () {
    object.destroy();
    object = null;
    editing = false;
});
...
mp.keys.bind(0x59, false, function () { // Y key
    ...
    mp.events.callRemote('acceptEditE', position.x, position.y, position.z, rotation.x, rotation.y, rotation.z);
    object.destroy();
    object = null;
    editing = false;
});
...
mp.keys.bind(0x4E, false, function () { // N key
    ...
    object = null;
    editing = false;
    mp.events.callRemote('cancelEditE');
});
