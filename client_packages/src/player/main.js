...
mp.events.add("client::checkbuckspade", () => {
	if (mp.players.local.vehicle || !loggedin || chatActive || editing || cuffed || localplayer.getVariable('InDeath') == true || mp.players.local.isFalling() || mp.players.local.isShooting() || mp.players.local.isSwimming() || mp.players.local.isSwimmingUnderWater() || global.fly.flying || isInSafeZone || curHeight < 0 || curHeight > 2) return;
