    ...
    class BusinessManager : Script
    {
        ...
        public static List<List<BusinessTattoo>> BusinessTattoos = new List<List<BusinessTattoo>>()
        {
            ...
            new List<BusinessTattoo>()
            {
                ...
                new BusinessTattoo(new List<int>(){ 2 }, "Alyxlight Ride", "mpstunt_overlays", "MP_MP_Stunt_Tat_008_M", "MP_MP_Stunt_Tat_008_F", 1800),
    ...
    public class Business
    {
        ...
        public Business(int id, string owner, int sellPrice, int type, List<Product> products, Vector3 enterPoint, Vector3 unloadPoint, int bankID, int mafia, List<Order> orders)
        {
            ...
            switch (Type)
            {
                ...
                case 15:
                case 16:
                    marker = NAPI.Marker.CreateMarker(27, EnterPoint + new Vector3(0, 0, 0.15), new Vector3(), new Vector3(), 1f, new Color(107, 107, 250, 0), false, 0);
                    break;
                case 2:
                case 3:
                case 4:
                case 17:
                    marker = NAPI.Marker.CreateMarker(36, EnterPoint + new Vector3(0, 0, 1), new Vector3(), new Vector3(), 0.7f, new Color(107, 107, 250, 0), false, 0);
                    break;
                case 5:
                    marker = NAPI.Marker.CreateMarker(37, EnterPoint + new Vector3(0, 0, 1), new Vector3(), new Vector3(), 0.7f, new Color(107, 107, 250, 0), false, 0);
                    break;
                case 11:
                ...
                case 12:
                case 13:
                    marker = NAPI.Marker.CreateMarker(26, EnterPoint + new Vector3(0, 0, 0.15), new Vector3(), new Vector3(), 3f, new Color(107, 107, 250), false, 0);
                    break;
            }
        }
