        ...
        private static void GiveOutPrizeMysticItem(Player player)
        {
            ...
            switch (randomInt)
            {
                case 0:
                    ...
                    Core.Weapons.GiveWeapon(player, ItemType.Flashlight, "Alyx");
                    break;
                case 1:
                    ...
                    Core.Weapons.GiveWeapon(player, ItemType.BattleAxe, "Alyx");
                    break;
                case 2:
                    ...
                    Core.Weapons.GiveWeapon(player, ItemType.FlareGun, "Alyx");
                    break;
                case 3:
                    ...
                    Core.Weapons.GiveWeapon(player, ItemType.StunGun, "Alyx");
                    break;
                case 4:
                    ...
                    Core.Weapons.GiveWeapon(player, ItemType.RepairKit, "Alyx");
                    break;
            }
        }
