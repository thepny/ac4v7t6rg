...
namespace Alyx.Core
{
    class Admin : Script
    {
        ...
        {
            if (!Group.CanUseCmd(player, "giveAlyxcoins")) return;
            ...
            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Вы отправили {target.Name} {amount} Alyx Coins", 3000);
            Notify.Send(target, NotifyType.Success, NotifyPosition.BottomCenter, $"+{amount} Alyx Coins", 3000);

            GameLog.Admin(player.Name, $"giveAlyxcoins({amount})", target.Name);
        }
        ...
        public static void delPlayerAdminGroup(Player player, Player target)
        {
            ...
            //Trigger.ClientEvent(target, "client::playsoundurl", "tistnyat");
