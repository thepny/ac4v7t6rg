...
namespace Alyx.Fractions
{
    class Police : Script
    {
        ...
        public static List<Vector3> policeCheckpoints = new List<Vector3>()
        {
            ...
            new Vector3(441.22977, -981.7129, 29.56957),  // vehicle boost                               9
        };
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                Cols.Add(7, NAPI.ColShape.CreateCylinderColShape(policeCheckpoints[9], 1, 2, 0));
        ...
        public static void interactPressed(Player player, int interact)
        {
            ...
            switch (interact)
            {
                ...
                case 66:
                    ...
                    Trigger.ClientEvent(player, "NPC.cameraOn", "LSPD", 1000);
