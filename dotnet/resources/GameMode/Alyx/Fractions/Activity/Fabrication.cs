    ...
    class AlcoFabrication : Script
    {
        ...
        */
        ...
        public void Event_ResourceStart()
        {
            try
            {
                NAPI.Blip.CreateBlip(93, new Vector3(-1388.761, -586.3921, 29.09945), 0.8f, 4, "Bahama Mamas West", 255, 0, true);
                NAPI.Blip.CreateBlip(93, new Vector3(141.3792, -1281.576, 28.2172), 0.8f, 4, "Vanila Unicorn", 255, 0, true);
                NAPI.Blip.CreateBlip(93, new Vector3(-564.5512, 275.6993, 81.98249), 0.8f, 4, "Tequi-la-la", 255, 0, true);
                NAPI.Blip.CreateBlip(93, new Vector3(-430.1028, 261.2774, 81.88689), 0.8f, 4, "Split Sides West Comedy Club", 255, 0, true);
