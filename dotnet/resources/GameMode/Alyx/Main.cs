    ...
    { 
        ...
        public void ClientEvent_Spawn(Player player, int id)
        {
            ...
            try
            {
                ...
                player.SendChatMessage($"Willkommen auf Exile RP, {name} {surname}!");
            ...
            try
            {
                ...
                switch (id)
                {
                    ...
                    case 956:
                        ...
                        return;
                        Fractions.Gangs.OpenCraftGang(player, 12);
                        Trigger.ClientEvent(player, "NPC.cameraOn", "YakuzaCraft", 1500);
                        return;
                    case 966:
