    ...
    class Electrician : Script
    {
        ...
        public static void StartWorkDay(Player player)
        {
            ...
            else
            {
                ...
                Trigger.ClientEvent(player, "createCheckpoint", 15, 1, Checkpoints[check].Position, 107, 107, 250, 0, 0);
                ...
                NAPI.Task.Run(() => {
                    try
                    {
                        if (player != null && Main.Players.ContainsKey(player))
                        {
                            ...
                            Trigger.ClientEvent(player, "createCheckpoint", 15, 1, Checkpoints[nextCheck].Position, 107, 107, 250, 0, 0);
